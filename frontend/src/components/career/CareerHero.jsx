    ...
    <section className="bg-primary-800 pt-20 pb-14 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span>/</span>
          <span className="text-white/65">Career</span>
        </motion.div>
        ...
        >
          ...
          <span className="text-accent-400"> actually matters</span>
        </motion.h1>
        ...
        >
          We are a small, focused team building defence and communication technology
          that is deployed in the field. If you care deeply about your craft and want
          your work to have real impact — we should talk.
        </motion.p>
