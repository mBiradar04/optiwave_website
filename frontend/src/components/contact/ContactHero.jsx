    ...
    <section className="bg-primary-800 pt-20 pb-14 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span>/</span>
          <span className="text-white/65">Contact Us</span>
        </motion.div>
        ...
        >
          Whether it's a product enquiry, partnership opportunity, or general question —
          fill in the form and we'll receive it directly in our inbox.
        </motion.p>
